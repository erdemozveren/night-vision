...
function layoutFn(self, range, overlay = null) {
  ...
  Object.assign(self, {
    ...
    ti2x: (t, i) => {
      const src = self.indexBased ? i + offset : t;
...
const logScale = {
  ...
  expand(self, height) {
    const A = -height / (math.log(self.$hi) - math.log(self.$lo));
    const B = -math.log(self.$hi) * A;
...
class Input {
  ...
  async listeners() {
    const Hamster = await import("./hamster-c2704c23.js").then((n) => n.h);
    const Hammer = await import("./hammer-dd8f469b.js").then((n) => n.h);
